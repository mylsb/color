...
var Index = function Index() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Div, {
    ...
    __self: this
  }, "Colorbox"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(TextButton, (_React$createElement = {
    ml: "auto",
    bg: "transparent",
    fontWeight: 700,
    fontSize: 2
  }, _defineProperty(_React$createElement, "ml", "auto"), _defineProperty(_React$createElement, "onClick", function onClick() {
    return togglePaletteModal(true);
  }), _defineProperty(_React$createElement, "__source", {
    fileName: _jsxFileName,
    lineNumber: 414
  }), _defineProperty(_React$createElement, "__self", this), _React$createElement), "Export palette")), activeTab === "url" && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Div, {
    px: 3,
    mx: "auto",
    maxWidth: "32rem",
    __source: {
    ...
    __self: this
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(TextInput, (_React$createElement2 = {
    type: "text",
    value: palxColor,
    ...
    px: 3,
    width: [3 / 4]
  }, _defineProperty(_React$createElement2, "type", "url"), _defineProperty(_React$createElement2, "border", "0"), _defineProperty(_React$createElement2, "bg", "gray.8"), _defineProperty(_React$createElement2, "borderRadius", 0), _defineProperty(_React$createElement2, "__source", {
    fileName: _jsxFileName,
    lineNumber: 563
  }), _defineProperty(_React$createElement2, "__self", this), _React$createElement2)), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Button, {
    py: 3,
    width: 1 / 4,
    bg: "gray.3",
    fontSize: 2,
...
//# sourceMappingURL=index.js.4500dfc5ab6db320bc32.hot-update.js.map